	...
	<div id="header_nav_container" class="container-fluid">
	    <div class="row-fluid">
		    <div id="header_nav" class="span12">
		    	 <a href="javascript:void(0)"><i class="icon-eye-open"></i>日志编辑 </a>
		    </div>
...
<form id="editForm" action="" method="post">
	<input type="hidden" name="id" value="${data.log.id }" />
	<input type="hidden" name="content" id="content" value=""/>
	<input type="hidden" name="summary" id="summary" value=""/>
	<div style="margin:1em;margin-top:2em">
		<em style="height:30px;">标题：</em>&nbsp;<input id="title" name="title" value="${data.log.title }" type="text" class="input-xlarge" maxlength="20" style="border: 1px solid rgb(198, 97, 97); background-color: rgb(251, 226, 226);">
 	</div>
	...
	<div class="divBelowUEditor">
		...
		<div class="belowUEditor">
			...
			<c:forEach var="logGroup" items="${data.logGroups}" varStatus="status"> 
				...
				<script>
				$("#groupSelect option[value='${data.log.groupId }']").prop("selected","selected");
				</script>
			<br/>
...
<script type="text/javascript" src="static/js/log/EditLog.js"></script>
